...
export const allRoutes = [
    ...
    new Route("/Connexion", "Page de connexion utilisateur", "/pages/auth/Connexion.html", "/js/connexion.js"),
    new Route("/Creationcompte", "Page de création de compte utilisateur", "/pages/auth/Creationcompte.html", "/js/Creationcompte.js"),
